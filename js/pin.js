...
(function () {
  ...
  tokyoPinMap.addEventListener('click', window.util.clickHandler(window.show_card.showCard));
  tokyoPinMap.addEventListener('keydown', window.util.entterPressHandler(window.show_card.showCard));
